...
CHANGELOG = [
    ...
    },
    {
        ...
        "items": [
            ...
            "기출 한 부를 올려 분석한 뒤 다음 기출을 올리고 '유형 분석하기'를 다시 "
            "누르면, 이미 읽은 기출은 다시 읽지 않고 새로 올린 것만 읽어 쌓습니다.",
            "기출이 둘 이상이면 합치기 표가 나옵니다. 해마다 몇 문항 나왔는지를 "
            "부별로 보여 주고, 한 번이라도 나온 유형은 1문항씩 깔아 둡니다 — "
            "3년에 한 번 나온 유형도 빠지지 않습니다. 남는 자리는 자주 나온 유형에 "
            "더 줍니다. 유형마다 개수를 직접 늘리고 줄일 수 있고, 안 낼 유형은 "
            "0으로 두면 됩니다.",
            ...
            "문제지 쪽수가 더 줄었습니다 — 두 단 조판이 쪽을 끝까지 채우지 않고 "
            "중간에서 끊겨, 쪽마다 아래쪽이 150~330pt씩 비어 있었습니다. 이제 "
            "한 단을 끝까지 채운 뒤 다음 단으로 넘어갑니다.",
        ],
    },
]
