...
CHANGELOG = [
    ...
    },
    {
        ...
        "date": "2026-08-29",
        "items": [
            "요약 이미지 값이 지문 1개당 400원에서 500원으로 올랐습니다. 그림 한 장을 "
            "만드는 원가가 다른 기능보다 훨씬 크고 환율에 따라 오르내리는 폭도 커서, "
            "그 폭을 견딜 만큼 조정했습니다. 요약 이미지 체크를 해제하면 이 값은 붙지 "
            "않으며, 지문 상세분석(300원)과 소책자 분석(200원)은 그대로입니다.",
        ],
    },
    {
        "version": 18,
